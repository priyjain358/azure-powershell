...
UPLOADCERTIFICATEREQUEST <IUploadCertificateRequest>: .
  [Certificate <String[]>]: 
.Link
https://docs.microsoft.com/powershell/module/az.stackhci/invoke-azstackhciuploadclustercertificate
#>
...
INPUTOBJECT <IStackHciIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/powershell/module/az.stackhci/new-azstackhciarcsettingpassword
#>
...
INPUTOBJECT <IStackHciIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/powershell/module/az.stackhci/update-azstackhciarcsetting
#>
